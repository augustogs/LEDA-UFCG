...
//		tree = new BSTImpl<>();
	...
	public void testSort() {
		this.tree.insert(5);
		this.tree.insert(20);
		Integer[] array = new Integer[] {5,2,8,10};
		assertArrayEquals(new Integer[] {2,5,8,10}, this.tree.sort(array));
		assertArrayEquals(new Integer[] {10,8,5,2}, this.tree.reverseOrder());
	}
}
